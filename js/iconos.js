...
const CATEGORIA_ICONS = {
 ...
 capilar: '<svg class="icon-svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c-1.5 1.5-3 5-3 8 0 2.5 1 4 2 5.5.8 1.2 1.5 2.2 1.5 3.5A2.5 2.5 0 0 1 10 21.5c3 0 5-2 5-5 0-1.7-.7-3.1-1.7-4.7C12.2 10 11 8 11 5.5 11 4 11.3 3 12 2z"/><path d="M16 5c0 1.5.8 2.8 1.6 4 .9 1.4 1.9 2.9 1.9 5 0 3.2-2.3 5.5-5.5 5.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',
